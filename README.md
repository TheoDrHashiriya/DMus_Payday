...
5. Select all the contents inside the folder and copy them outside of that folder.
6. Delete *DMus_Payday-main*.
7. Load both the new music pack archive and the mod into GZDoom.
