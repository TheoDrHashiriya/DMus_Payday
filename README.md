...
3. Extract the contents of the music pack archive. (Do not use the "Extract to \folder\\." option.)
4. Select all the contents inside the folder and add them to archive.
